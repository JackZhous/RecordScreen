...
public class AudioManager {
    ...
    private int samplingRate = Config.AAC_SAMPLE_RATE;
    private int bitRate = Config.AAC_BITRATE;
    ...
    private void initCode() throws IOException {
        ...
        format.setInteger(MediaFormat.KEY_CHANNEL_COUNT, Config.ACC_CHANNELS);// 声道数
        ...
        public void run() {
            ...
            do {
                ...
                if (index >= 0) {
                    ...
                    pusher.push(mBuffer.array(), 0, mBufferInfo.size + 7, 0, 0);
